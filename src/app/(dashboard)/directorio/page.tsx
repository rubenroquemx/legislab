    ...
    <div className="w-full flex-1 flex flex-col space-y-0 sm:space-y-4">
                          ...
                          <IosSwipeableRow
                            ...
                            actionsRight={[
                              ...
                              },
                              {
                                ...
                                color: 'bg-red-600',
                                onClick: () => setModalDeleteId(contacto.id),
                              },
                            ]}
                          >
                            <div
      ...
      {modalDeleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-xs p-4 animate-in fade-in duration-150">
          <div className="bg-white dark:bg-[#121824] rounded-2xl border border-gray-200/80 dark:border-gray-800 max-w-sm w-full p-6 shadow-2xl space-y-4 text-center animate-in zoom-in-95 duration-150">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Esta acción removerá el contacto y su historial del directorio oficial de forma permanente.
              </p>
            </div>
            <div className="flex items-center justify-center gap-3 pt-2">
              <button
                ...
                className="px-4 py-2 text-xs font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800 rounded-xl cursor-pointer transition-colors"
              >
                Cancelar
              </button>
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold bg-red-600 hover:bg-red-700 text-white rounded-xl shadow-sm cursor-pointer transition-all active:scale-95"
              >
                <Trash2 className="h-3.5 w-3.5" />
